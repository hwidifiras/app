...
const ACTION_LABELS: Record<string, string> = {
  ...
  GROUP_SCHEDULE_CREATED: "Horaire de groupe cree",
...
const CLUB_FIELD_LABELS: Record<string, string> = {
  ...
  dashboardDefaultMode: "Vue dashboard par defaut",
  dashboardShowTodaySessions: "Dashboard - seances du jour",
  dashboardShowCashToday: "Dashboard - caisse aujourd'hui",
  dashboardShowDataConfidence: "Dashboard - alertes donnees",
  dashboardShowCashTrend: "Dashboard - tendance encaissements",
  dashboardShowMembersOverview: "Dashboard - apercu membres",
  dashboardShowCommercialInsights: "Suivi commercial dashboard",
  dashboardShowDetailedDebts: "Dashboard - impayes detailles",
