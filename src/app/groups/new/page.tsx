...
export default async function NewGroupPage() {
  ...
  let membersOptions: Array<{ id: string; firstName: string; lastName: string; phone: string; email: string | null; memberType: "ADULT" | "KID" | "NOT_SPECIFIED"; gender: "MALE" | "FEMALE" | "NOT_SPECIFIED"; status: "ACTIVE" | "ARCHIVED"; birthDate: string | null; address: string | null; parentName: string | null; parentPhone: string | null; parentAddress: string | null; paymentStatus: string; joinedAt: string; archivedAt: string | null; createdAt: string; updatedAt: string; groupIds: string[]; }> = [];
  ...
  try {
    ...
    coachesOptions = coaches.map(buildCoachDto);
