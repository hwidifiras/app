  ...
  return (
    <div
      className={cn(
        ...
        sticky &&
          "sticky bottom-[calc(var(--app-mobile-nav-clearance)+env(safe-area-inset-bottom,0px))] z-20 rounded-t-lg border-t border-border bg-[var(--background)] pb-2 pt-2 shadow-[0_-10px_24px_-8px_rgba(15,23,42,0.14)] md:-mx-4 md:rounded-none md:px-4 md:pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:bottom-0",
        className,
      )}
    >
